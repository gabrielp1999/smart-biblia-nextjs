...
function PageBook() {
  ...
  const book = {
    nome: "Salmos",
    capitulo: 29 ,
    versiculos: ["Atribuam ao Senhor, ó seres celestiais, atribuam ao Senhor glória e força.", "Atribuam ao Senhor a glória que o seu nome merece; adorem o Senhor no esplendor do seu santuário.", "A voz do Senhor ressoa sobre as águas; o Deus da glória troveja, o Senhor troveja sobre as muitas águas.", "A voz do Senhor é poderosa; a voz do Senhor é majestosa."]
  }
